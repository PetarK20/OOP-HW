...
Клас __*Author*__ Представлява автор на книга.
...
Клас `_*Book*_` Представлява книга с основни характеристики, като агрегира обекта `Author`.
...
Клас `_*Member*_` Представлява регистриран член на библиотеката.
...
Клас `_*Loan*_` Представлява запис за зает ресурс, свързващ книга (по ISBN) и член (по ID).
...
Клас `_*Library*_` Управлява цялата библиотечна система, съхранявайки и обработвайки колекциите от книги, членове и заеми.
